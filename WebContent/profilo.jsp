		...
		<div class="modal fade" id="modalModifica" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    		<div class="modal-dialog" role="document">
        		<div class="modal-content">
            		...
            		<form action="User" method="get" role="form" data-toggle="validator">
           			<div class="modal-body">
           				<div class="form-group">
    						<label for="nick" class="control-label">Nickname</label>
    						<input name="nickname" pattern="^[_A-z0-9]{1,20}$" type="text" class="form-control" id="nick" value="<%=utente.getNick()%>">
    						<div class="help-block with-errors">Only letters and numbers, no special characters</div>
  						</div>
  						<div class="form-group">
    						<label for="pass" class="control-label">Password</label>
        					<input name="password" type="password" pattern="^[_A-z0-9]{6,15}$" class="form-control" id="pass" value="<%=utente.getPassword()%>">
      					...
      					<div class="form-group">
        					...
        					<input type="password" class="form-control" id="pass-conf" data-match="#pass" data-match-error="Whoops, these don't match" placeholder="Confirm" required>
        					<div class="help-block with-errors"></div>
        				</div>
        				<div class="form-group">
   							<label for="mail">Email</label>
   							<input name="email" class="form-control" type="email" id="mail" value="<%=utente.getEmail()%>">
   							<div class="help-block with-errors"></div>
  						</div>
            		</div>
            		
            		<div class="modal-footer">
            			<input name="username" type="hidden" id="user" value="<%=utente.getUsername()%>">
                		<button type="submit" id="modifica" class="btn btn-primary btn-lg btn-block">Modifica<i class="fas fa-paper-plane"></i></button>
            		</div>
            		</form>
        		</div>
    		</div>
